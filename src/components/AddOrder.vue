    ...
    <div class="container" >
        <form action="#" @submit.prevent="addOrder">
            ...
            <div class="col-md-12">
                ...
                <input type="text" v-model="postData.Email" class="form-control" id="inputId4">
            </div>
            <div class="col-md-12">
                <label for="inputName4" class="form-label">FoodId</label>
                <input type="number" v-model="postData.FoodId" class="form-control" id="inputName4">
            </div>
            <div class="col-md-12">
                <label for="inputRest4" class="form-label">RestoId</label>
                <input type="number" v-model="postData.RestoId" class="form-control" id="inputRest4">
            </div>
            <div class="col-md-12">
                <label for="inputQuantity2" class="form-label">Quantity</label>
                <input type="number" v-model="postData.Quantity" class="form-control" id="inputQuantity2">
            </div>
            <div class="col-md-12">
                <label for="inputPrice4" class="form-label">Price</label>
                <input type="number" v-model="postData.Price" class="form-control" id="inputPrice4">
            </div>
            <div class="col-md-12">
                <label for="Total" class="form-label">Total</label>
                <input type="number" v-bind="postData.Total" class="form-control mb-3" id="inputTota;">
              
                    <div class="col-12" >       
                 <button type="submit" class="btn btn-dark" >  <router-link to="/OrderDetails">Add Order</router-link></button>
              </div>
            </div>
        </form>
    </div>
